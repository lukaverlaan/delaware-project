...
class GebruikerTest {
    ...
    void builder_gooitValidatieException(String naam,
                                         String voornaam,
                                         String email,
                                         Rol rol,
        ...
        ValidatieException ex = assertThrows(
                ValidatieException.class,
                builder::build
        );

        // Controleer of de juiste validatiefout aanwezig is
        assertTrue(
                ex.getFouten().keySet().containsAll(expectedFouten.keySet())
        );
    }
