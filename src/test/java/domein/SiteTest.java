...
class SiteTest {
    ...
    class ValidationTests {
        ...
        class MissingFieldTests {
            ...
            void testMissingField(String testName, String fieldName, SiteAttributes expectedAttribute) {
                ...
                assertTrue(
                        exception.getMissingAttributes().contains(expectedAttribute),
                        "Exception moet " + expectedAttribute + " bevatten"
                );
            }
        }
        ...
        class InvalidFieldTests {
            ...
            void testInvalidCapaciteit(String testName, int capaciteit) {
                ...
                assertTrue(
                        exception.getMissingAttributes().contains(SiteAttributes.CAPACITEIT),
            ...
            void testEmptyNaam() {
                ...
                assertTrue(exception.getMissingAttributes().contains(SiteAttributes.NAAM));
            }
            ...
            void testNullLocatie() {
                ...
                SiteException exception = assertThrows(SiteException.class, builder::buildSite);
                assertTrue(exception.getMissingAttributes().contains(SiteAttributes.LOCATIE));
            }
        }
    }
    ...
    class MultipleValidationErrorsTests {
        ...
        void testMultipleMissingFields() {
            ...
            Set<SiteAttributes> missing = exception.getMissingAttributes();
            assertTrue(missing.contains(SiteAttributes.LOCATIE));
            assertTrue(missing.contains(SiteAttributes.CAPACITEIT));
            assertTrue(missing.contains(SiteAttributes.OPERATIONELE_STATUS));
            assertTrue(missing.contains(SiteAttributes.PRODUCTIE_STATUS));
        ...
        void testAllFieldsMissing() {
            ...
            assertTrue(missing.contains(SiteAttributes.NAAM));
            assertTrue(missing.contains(SiteAttributes.LOCATIE));
            assertTrue(missing.contains(SiteAttributes.CAPACITEIT));
            assertTrue(missing.contains(SiteAttributes.OPERATIONELE_STATUS));
            assertTrue(missing.contains(SiteAttributes.PRODUCTIE_STATUS));
