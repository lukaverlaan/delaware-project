...
public class GebruikerDetailController {
    ...
    @FXML private TextField personeelsnummerField;
    ...
    private void initialize() {
        ...
        if (dto.status() == Status.ACTIEF)
            actiefRadio.setSelected(true);
        else
            inactiefRadio.setSelected(true);
    }
    ...
    private void handleOpslaan() {
        ...
        try {
            ...
            GebruikerDTO updatedDTO = new GebruikerDTO(
                    dto.id(),
                    dto.personeelsnummer(),
                    naamField.getText().trim(),
                    voornaamField.getText().trim(),
                    emailField.getText().trim(),
                    telefoonField.getText().isBlank() ? null : telefoonField.getText().trim(),
                    straatField.getText().trim(),
                    nummerField.getText().trim(),
                    postbusField.getText().isBlank() ? null : postbusField.getText().trim(),
                    stadField.getText().trim(),
