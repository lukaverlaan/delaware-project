...
public class VoegGebruikerToeController {
    ...
    private void initialize() {
        ...
        rolComboBox.valueProperty().addListener((obs, oldValue, newValue) -> {
            ...
            telefoonLabel.setText(rol == Rol.WERKNEMER ? "Telefoonnummer" : "Telefoonnummer (optioneel)");
        });
    }
    ...
    public Parent getView() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/_026javag03/gui/VoegGebruikerToeScherm.fxml"));
